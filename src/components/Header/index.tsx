            ...
            <div className="w-60 max-w-full px-4">
              ...
              >
                {pathUrl !== "/" ? (
                  <>
                    <Image
                      src={`/images/logo/swstudio-black.svg`}
                      alt="logo"
                      width={240}
                      height={30}
                    ...
                    />
                    <Image
                      src={`/images/logo/swstudio-white.svg`}
                      alt="logo"
                      width={240}
                      height={30}
                  ...
                  <>
                    <Image
                      src={`${
                        sticky
                          ? "/images/logo/swstudio-black.svg"
                          : "/images/logo/swstudio-white.svg"
                      }`}
                      alt="logo"
                      width={140}
                      height={30}
            ...
            <div className="flex w-full items-center justify-between px-4">
                      ...
                      menuItem.path ? (
                        <li key={index} className="group relative">
                          {pathUrl !== "/" ? (
                            <Link
                              onClick={()=>{
                                menuItem.func ? menuItem.func() : console.log("Click");
                                navbarToggleHandler()
                              }}
                              scroll={false}
                              href={menuItem.path}
              ...
              <div className="hidden items-center justify-end pr-16 sm:flex lg:pr-0">
                ...
                <button
                  ...
                  className="flex h-8 w-8 mr-6 items-center justify-center text-body-color duration-300 dark:text-white"
                >
                  <span>
                    <svg
                      viewBox="0 0 16 16"
