    ...
    <section id="faq" className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
      <div className="container">
        <SectionTitle
          ...
          paragraph="Explore our FAQs to learn more about our services, process, and how we can help your business grow."
          width="640px"
          center
        />
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              ...
              answer="People interact with hundreds of businesses every day. On the subway, on the bus, in the city, on their phones, they come across new businesses daily. So, what makes yours stand out? The answer lies in digital marketing services."
            />
            <SingleFaq
              question="Why should I get SEO services?"
              answer="While social media is great, it doesn’t replace Google searches. SEO services help to make your brand stand out in search results."
            />
            <SingleFaq
              question="Why Social Media Marketing?"
              answer="Our people spend a large part of their days on social media. Don’t you think it would benefit your business if they saw your products and offers during that time?"
            />
          </div>
          ...
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              ...
              answer="People can't just access your social media accounts. You need a website to present all your information in a compact way. Web design services are just one click away."
            />
            <SingleFaq
              question="Why do I need to advertise on Google?"
              answer="Every day, thousands of people search for products they want to buy but can't decide on. To reach them, you should use Google PPC ads."
            />
            <SingleFaq
              question="How long does it take to see results from digital marketing?"
              answer="The timeline for seeing results from digital marketing can vary depending on the strategy and goals. Generally, you might start seeing initial results within a few weeks, but achieving significant and sustainable outcomes often takes several months."
            />
          </div>
        </div>
      </div>
