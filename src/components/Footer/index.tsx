          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="-mx-3 flex items-center">
                ...
                <a
                  aria-label="social link"
                  href="https://instagram.com/shukurweb.studio"
                  className="px-3 text-gray-7 hover:text-white"
                >
                  <svg
                    width="22"
                ...
                <a
                  target="blank"
                  aria-label="social link"
                  href="https://www.linkedin.com/company/shukur-web-studio/"
                  className="px-3 text-gray-7 hover:text-white"
                >
                  <svg
                    width="22"
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                ...
                <li>
                  <a
                  onClick={()=> document.querySelector("#service-sec")?.scrollIntoView({behavior:"smooth"})}
                    href="/#services-sec"
                    className="mb-3 inline-block text-base text-gray-7 hover:text-primary"
                  >
                    Services
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                <p className="text-base text-gray-7">
                  Shukur Web Studio © {new Date().getFullYear()}
                </p>
              </div>
            </div>
          </div>
